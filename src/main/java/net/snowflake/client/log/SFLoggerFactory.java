...
public class SFLoggerFactory
{
   ...
   * For example, the name we have is an alias name of a class, we can't get the correct Class&lt;?&gt; by the given name.
   *
   * @param name name to indicate the class (might be different with the class name) that the logger is instantiated
