 ...
 * This class contains functions that are used exclusively within the WIF package.
 */
...
public class WorkloadIdentityUtil {
    ...
    /**
     * Performs an HTTP request for WIF identity token retrieval.
     * This method is used by WIF authentication flows to communicate with cloud metadata services.
     */
    ...
    /**
     * Extracts claims (subject and issuer) from a JWT token without verifying the signature.
     * This is used in WIF flows where signature verification is handled elsewhere.
     */
    public static SubjectAndIssuer extractClaimsWithoutVerifyingSignature(String token) throws SFException {
    ...
    /**
     * Container class for JWT subject and issuer claims.
     * Used in WIF authentication flows to pass extracted token claims.
     */
