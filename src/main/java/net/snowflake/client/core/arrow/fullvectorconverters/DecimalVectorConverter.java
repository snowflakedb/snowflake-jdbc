...
public class DecimalVectorConverter extends SimpleArrowFullVectorConverter<DecimalVector> {
    ...
    public DecimalVectorConverter(RootAllocator allocator, ValueVector vector, DataConversionContext context, SFBaseSession session, int idx) {
    ...
    @Override
    protected void convertValue(ArrowVectorConverter from, DecimalVector to, int idx) throws SFException {
