...
public class SFSession extends SFBaseSession {
  ...
  private static Duration httpClientConnectionTimeout = HttpUtil.getConnectionTimeout();
  private static Duration httpClientSocketTimeout = HttpUtil.getSocketTimeout();
