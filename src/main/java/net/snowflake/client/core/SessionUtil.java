...
public class SessionUtil {
  ...
  private static final String JDBC_USE_WALLCLOCK_TIME = "JDBC_USE_WALLCLOCK_TIME";
  ...
  static void updateSfDriverParamValues(Map<String, Object> parameters, SFSession session) {
    for (Map.Entry<String, Object> entry : parameters.entrySet()) {
      ...
      } else if (JDBC_USE_WALLCLOCK_TIME.equalsIgnoreCase(entry.getKey())) {
        if (session != null) {
          session.useWallclockTime((boolean) entry.getValue());
        }
