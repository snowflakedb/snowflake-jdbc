...
public class IncidentV2DTO {
  ...
  public static class ValuesDTO {
    ...
    public ValuesDTO(
        String requestId, String jobId, String exceptionMessage, String exceptionStackTrace) {
  ...
  public IncidentV2DTO(Incident incident) {
    ...
    this.Value =
        new ValuesDTO(
            incident.requestId, incident.jobId, incident.errorMessage, incident.errorStackTrace);
