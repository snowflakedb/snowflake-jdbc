...
{
  private static final SFLogger
      logger = SFLoggerFactory.getLogger(Incident.class);
  private static final String SF_PATH_CREATE_INCIDENT_V2 =
      "/incidents/v2/create-incident";
           ...
           String raiser)
  {
    ...
    this.signature = generateSignature(errorMessage,
                                       raiser);
