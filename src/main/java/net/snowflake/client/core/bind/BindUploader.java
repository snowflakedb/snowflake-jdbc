...
public class BindUploader implements Closeable
{
  ...
  {
    ArrayList<ArrayList<String>> columns = getColumnValues(bindValues);
   ...
   * @throws BindException
   */
  private ArrayList<ArrayList<String>> getColumnValues(Map<String, ParameterBindingDTO> bindValues) throws BindException
  {
    ArrayList<ArrayList<String>> columns = new ArrayList<>(bindValues.size());
    for (int i = 1; i <= bindValues.size(); i++)
    {
      ...
      try
      {
        ArrayList<String> list = (ArrayList<String>) value.getValue();
   ...
   * @throws BindException
   */
  private List<String[]> buildRows(ArrayList<ArrayList<String>> columns) throws BindException
  {
  ...
  private void putBinds() throws BindException
  {
    ...
    String putStatement = String.format(PUT_STMT, bindDir.toString(), stagePath);
