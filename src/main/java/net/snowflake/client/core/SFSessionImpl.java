...
public class SFSessionImpl implements SFSession {
  private static final ObjectMapper OBJECT_MAPPER = ObjectMapperFactory.getObjectMapper();

  static final SFLogger logger = SFLoggerFactory.getLogger(SFSessionImpl.class);
  ...
  protected void heartbeat() throws SFException, SQLException {
    ...
    do {
      try {
        ...
        uriBuilder.addParameter(SFSessionImpl.SF_QUERY_REQUEST_ID, requestId);
  ...
  private SFBaseResultSet runInternalCommand(String sql, String value) {
    ...
    try {
      ...
      SFStatementImpl statement = new SFStatementImpl(this);
