...
class GcmEncryptionProvider {
  ...
  static byte[] encrypt(
      ...
      byte[] keyBytes,
      byte[] iv,
      byte[] aad) throws NoSuchPaddingException, NoSuchAlgorithmException, InvalidAlgorithmParameterException, InvalidKeyException, IllegalBlockSizeException, BadPaddingException {
  ...
  private static byte[] process(byte[] kekBytes, byte[] keyBytes, byte[] iv, byte[] aad, int encryptMode) throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException {
