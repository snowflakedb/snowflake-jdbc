...
class EncryptionHelperFactory {
  public static final String formatVersionKey = "sf_client_side_encryption_format_version";
...
class GcmDecryptionHelper implements DecryptionHelper {
  static final String keyCipherKey = "sf_client_side_encryption_key_cipher";
  static final String keyEncryptionParametersKey =
      "sf_client_side_encryption_key_encryption_parameters";
  static final String keyKey = "sf_client_side_encryption_key";
  static final String contentCipherKey = "sf_client_side_encryption_content_cipher";
  static final String contentEncryptionParametersKey =
      "sf_client_side_encryption_content_encryption_parameters";
  ...
  public GcmDecryptionHelper(
    ...
    Map<String, String> contentParameters =
        objectMapper.readerFor(Map.class).readValue(metaMap.get(contentEncryptionParametersKey));
    this.contentHeader =
