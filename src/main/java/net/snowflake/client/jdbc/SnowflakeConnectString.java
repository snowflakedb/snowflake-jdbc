...
public class SnowflakeConnectString implements Serializable
{
  ...
  private static SnowflakeConnectString INVALID_CONNECT_STRING = new SnowflakeConnectString(
  ...
  private SnowflakeConnectString(String scheme, String host, int port, Map<String, Object> parameters, String account)
  {
    this.scheme = scheme;
    this.host = host;
    this.port = port;
  ...
  public String toString(boolean maskSensitiveValue)
  {
    ...
    for (Map.Entry<String, Object> entry : parameters.entrySet())
    {
      ...
      try
      {
        ...
        if (maskSensitiveValue && "password".equalsIgnoreCase(k) || "passcode".equalsIgnoreCase(k) ||
