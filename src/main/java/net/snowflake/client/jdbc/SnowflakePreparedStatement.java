...
public interface SnowflakePreparedStatement {
   ...
   * @param x an <code>SnowflakeType</code> object that maps an Snowflake type
   * @exception SQLException if parameterIndex does not correspond to a parameter marker in the SQL
   ...
   * @throws SQLException
   */
  <T> void setMap(int parameterIndex, Map<String, T> map, int type, SnowflakeType snowflakeType)
      throws SQLException;
}
