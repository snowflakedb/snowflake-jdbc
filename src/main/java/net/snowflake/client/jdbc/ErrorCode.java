...
public enum ErrorCode {
  ...
  OAUTH_AUTHORIZATION_CODE_FLOW_ERROR(200064, SqlState.CONNECTION_EXCEPTION),
  OAUTH_CLIENT_CREDENTIALS_FLOW_ERROR(200065, SqlState.CONNECTION_EXCEPTION),
  OAUTH_REFRESH_TOKEN_FLOW_ERROR(200066, SqlState.CONNECTION_EXCEPTION),
  DISABLEOCSP_INSECUREMODE_VALUE_MISMATCH(200067, SqlState.INVALID_PARAMETER_VALUE);
