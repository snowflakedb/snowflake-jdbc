...
public enum ErrorCode {
  ...
  OAUTH_AUTHORIZATION_CODE_FLOW_ERROR(200065, SqlState.CONNECTION_EXCEPTION),
  OAUTH_CLIENT_CREDENTIALS_FLOW_ERROR(200066, SqlState.CONNECTION_EXCEPTION),
  OAUTH_REFRESH_TOKEN_FLOW_ERROR(200067, SqlState.CONNECTION_EXCEPTION),
  TOO_MANY_FILES_TO_DOWNLOAD_AS_STREAM(200068, SqlState.DATA_EXCEPTION);
