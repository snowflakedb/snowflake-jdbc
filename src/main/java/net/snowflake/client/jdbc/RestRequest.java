...
public class RestRequest {
  ...
  //
  //    // Used to indicate that this is a login/auth request and will be using the new retry
  // strategy.
  ...
  //            ex.getMessage()
  //                + "\n"
  //                + "Verify that the hostnames and portnumbers in SYSTEM$ALLOWLIST are added to
  // your firewall's allowed list.\n"
  ...
  //              HttpUtil.getDefaultRequestConfigWithSocketTimeout(origSocketTimeout,
  // withoutCookies));
  //        }
  //      }
  //
  ...
  //          logger.error(
  //              "{}Stop retrying as max retries have been reached for request: {}! Max retry
  // count: {}",
  //              requestIdStr,
  //              requestInfoScrubbed,
  //              maxRetries);
  ...
  //        // increase the retry count and throw special exception to renew the token before
  // retrying.
  //
