...
public class SnowflakeDatabaseMetaData implements DatabaseMetaData {
  ...
  private static final String NumericFunctionsSupported =
      "ABS,ACOS,ASIN,"
  ...
  private static final String StringFunctionsSupported =
      "ASCII,CHAR,"
  ...
  public String getDriverVersion() throws SQLException {
    ...
    String newClientForUpdate = ((SnowflakeConnectionV1) connection).getNewClientForUpdate();
  ...
  public ResultSet getProcedureColumns(
    ...
    return new SnowflakeDatabaseMetaDataResultSet(
        Arrays.asList(
            ...
            "SPECIFIC_NAME"),
        Arrays.asList(
            "TEXT", "TEXT", "TEXT", "TEXT", "SHORT", "INTEGER", "TEXT", "INTEGER", "INTEGER",
            "SHORT", "SHORT", "SHORT", "TEXT", "TEXT", "INTEGER", "INTEGER", "INTEGER", "INTEGER",
            "TEXT", "TEXT"),
        Arrays.asList(
            Types.VARCHAR,
            Types.VARCHAR,
    ...
    if (logger.isDebugEnabled()) {
      logger.debug(
          "public ResultSet getTables(String catalog={}, String "
              ...
              + "String[] types={})",
          new Object[] {catalog, schemaPattern, tableNamePattern, Arrays.toString(types)});
    }
          ...
          if ((compiledTablePattern == null || compiledTablePattern.matcher(tableName).matches())
            ...
            nextRow[15] =
                (columnMetadata.getType() == Types.VARCHAR
                        || columnMetadata.getType() == Types.CHAR)
                    ? new Integer(columnMetadata.getLength())
                    : null;
        ...
        while (showObjectResultSet.next()) {
          ...
          if (client.equals("import")) {
            ...
            if ((finalParentCatalog == null || finalParentCatalog.equals(fktable_cat))
                ...
                && (parentTable == null || parentTable.equals(fktable_name))) passedFilter = true;
            ...
            if ((finalParentCatalog == null || finalParentCatalog.equals(pktable_cat))
                ...
                && (parentTable == null || parentTable.equals(pktable_name))) passedFilter = true;
            ...
            if ((finalParentCatalog == null || finalParentCatalog.equals(pktable_cat))
                ...
                && (foreignTable == null || foreignTable.equals(fktable_name))) passedFilter = true;
          }
  ...
  /**
   * Returns the ODBC standard property string for the property string used in our show constraint
   * commands
   *
   * @param property_name
   * @param property
  ...
  private short getForeignKeyConstraintProperty(String property_name, String property) {
    ...
    if (property_name.equals("update") || property_name.equals("delete")) {
      if (property.equals("NO ACTION")) result = importedKeyNoAction;
      if (property.equals("CASCADE")) result = importedKeyCascade;
      if (property.equals("SET NULL")) result = importedKeySetNull;
      if (property.equals("SET DEFAULT")) result = importedKeySetDefault;
      if (property.equals("RESTRICT")) result = importedKeyRestrict;
    } else // deferrability
    {
      if (property.equals("INITIALLY DEFERRED")) result = importedKeyInitiallyDeferred;
      else if (property.equals("INITIALLY IMMEDIATE")) result = importedKeyInitiallyImmediate;
      else if (property.equals("NOT DEFERRABLE")) result = importedKeyNotDeferrable;
    }
  ...
  public ResultSet getFunctions(String catalog, String schemaPattern, String functionNamePattern)
    ...
    if (catalog == null) {
      ...
      if (schemaPattern == null || Wildcard.isWildcardPatternStr(schemaPattern)) {
        ...
        schemaPattern = schemaPattern.replace("\\", "");
        showFunctionCommand += " in schema \"" + catalog + "\".\"" + schemaPattern + "\"";
      }
    }

    logger.debug("sql command to get column metadata: {}", showFunctionCommand);
