...
public class SnowflakeDatabaseMetaData implements DatabaseMetaData {
  ...
  private static final String notSQL2003Keywords =
      "ACCOUNT,DATABASE,SCHEMA,VIEW,ISSUE,DATE_PART,EXTRACT,"
          ...
          + "FORMATS,FUNCTIONS,GRANTS,GSCLUSTER,GSINSTANCE,GSINSTANCES,HELP,HIBERNATE,HINTS,"
          + "HISTORY,IDENTIFIED,ILIKE,IMMUTABLE,IMPORTED,INCIDENT,INCIDENTS,INFO,INITIALLY,"
          ...
          + "SOME,STAGE,STAGES,STATEMENT,STATISTICS,STOP,STORED,STRICT,STRUCT,SUSPEND,SUSPEND_IMMEDIATE,SWAP,SWITCH,T,"
