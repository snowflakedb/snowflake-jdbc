...
public class SnowflakeFileTransferAgentImpl
  ...
  private SFSessionImpl session;
  private SFStatementImpl statement;
  ...
  private void initEncryptionMaterial(
    ...
    if (commandType == SnowflakeFileTransferAgent.CommandType.UPLOAD) {
      ...
      if (commandType == SnowflakeFileTransferAgent.CommandType.UPLOAD) {
        threadExecutor.submit(
            getUploadFileCallable(
                ...
                null,
                encMat));
      } else if (commandType == SnowflakeFileTransferAgent.CommandType.DOWNLOAD) {
        throw new SnowflakeSQLLoggedException(
  ...
  public static void renewExpiredToken(
      SFSessionImpl session, String command, SnowflakeStorageClient client)
      throws SnowflakeSQLException {
    SFStatementImpl statement = new SFStatementImpl(session);
    JsonNode jsonNode = parseCommandInGS(statement, command);
    Map<?, ?> stageCredentials = extractStageCreds(jsonNode);
