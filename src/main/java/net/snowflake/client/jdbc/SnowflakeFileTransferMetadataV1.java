 ...
 * It is introduced for distributed data processing. The typical use case is:
 *   1. The cluster master has JDBC connection to the Snowflake and
 *       it can generate this object for the file transfer.
 *   2. The cluster master node can transfer the object to cluster worker.
 *   3. The cluster worker can upload or download data with the object without
 *      JDBC Connection.
 *
 * NOTE: When this class is created, it only supports UPLOAD for GCS.
 *       It is created for Snowflake Spark Connector.
 */
        ...
        implements SnowflakeFileTransferMetadata, Serializable
{
    ...
    public SnowflakeFileTransferMetadataV1(String presignedUrl,
    ...
    public void setEncryptionMaterial(
            ...
            Long encryptionMaterial_smkId)
    {
        this.encryptionMaterial_queryStageMasterKey =
                encryptionMaterial_queryStageMasterKey;
        this.encryptionMaterial_queryId = encryptionMaterial_queryId;
        this.encryptionMaterial_smkId = encryptionMaterial_smkId;
    }
