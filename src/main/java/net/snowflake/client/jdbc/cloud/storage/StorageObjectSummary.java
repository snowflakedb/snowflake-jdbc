...
public class StorageObjectSummary {
   ...
   */
  public static StorageObjectSummary createFromS3ObjectSummary(S3Object objSummary) {
   ...
   *
   * <p>create these objects since Azure can throw, while retrieving the BLOB properties
   *
