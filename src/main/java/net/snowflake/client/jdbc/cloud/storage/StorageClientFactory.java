...
public class StorageClientFactory {
    ...
    switch (stage.getStageType()) {
      case S3:
        return createS3Client(
            stage.getCredentials(), parallel, encMat, stage.getRegion(), stage.getEndPoint());
  ...
  private SnowflakeS3Client createS3Client(
    ...
    try {
      s3Client =
          new SnowflakeS3Client(stageCredentials, clientConfig, encMat, stageRegion, stageEndPoint);
    } catch (Exception ex) {
