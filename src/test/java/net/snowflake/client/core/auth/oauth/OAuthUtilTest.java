...
public class OAuthUtilTest {
    ...
    public void shouldCreateDefaultAuthorizationUrl() {
        ...
        URI authorizationUrl = OAuthUtil.getAuthorizationUrl(loginInput, BASE_SERVER_URL_FROM_LOGIN_INPUT);
    ...
    public void shouldCreateUserSuppliedAuthorizationUrl() {
        SFOauthLoginInput loginInput = createLoginInputStub("http://some.external.authorization.url.com/authz", null, null);
        URI tokenRequestUrl = OAuthUtil.getAuthorizationUrl(loginInput, BASE_SERVER_URL_FROM_LOGIN_INPUT);
        Assertions.assertNotNull(tokenRequestUrl);
        Assertions.assertEquals("http://some.external.authorization.url.com/authz", tokenRequestUrl.toString());
    }

    @Test
    public void shouldCreateDefaultTokenRequestUrl() {
        SFOauthLoginInput loginInput = createLoginInputStub(null, null, null);
        URI tokenRequestUrl = OAuthUtil.getTokenRequestUrl(loginInput, BASE_SERVER_URL_FROM_LOGIN_INPUT);
        Assertions.assertNotNull(tokenRequestUrl);
    ...
    public void shouldCreateUserSuppliedTokenRequestUrl() {
        SFOauthLoginInput loginInput = createLoginInputStub(null, "http://some.external.authorization.url.com/token-request", null);
        URI tokenRequestUrl = OAuthUtil.getTokenRequestUrl(loginInput, BASE_SERVER_URL_FROM_LOGIN_INPUT);
        Assertions.assertNotNull(tokenRequestUrl);
    ...
    private SFOauthLoginInput createLoginInputStub(String externalAuthorizationUrl, String externalTokenRequestUrl, String scope) {
        return new SFOauthLoginInput(null, null, null, externalAuthorizationUrl, externalTokenRequestUrl, scope);
    }
