...
public class PlatformDetectionUtilTest {
    ...
    class HasValidAwsIdentityForWifTests {
        ...
        public void testValidUserArn() {
            ...
            when(mockCredentials.getAWSSecretKey()).thenReturn("wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY");
            when(mockAttestationService.getArn()).thenReturn("arn:aws:iam::123456789012:user/ExampleUser");
        ...
        public void testValidAssumedRoleArn() {
            ...
            when(mockCredentials.getAWSAccessKeyId()).thenReturn("AKIAIOSFODNN7EXAMPLE");
            when(mockCredentials.getAWSSecretKey()).thenReturn("wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY");
            when(mockAttestationService.getArn()).thenReturn("arn:aws:sts::123456789012:assumed-role/MyRole/MySession");
        ...
        public void testUnsupportedEc2InstanceArn() {
            ...
            when(mockCredentials.getAWSAccessKeyId()).thenReturn("AKIAIOSFODNN7EXAMPLE");
            when(mockCredentials.getAWSSecretKey()).thenReturn("wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY");
            when(mockAttestationService.getArn()).thenReturn("arn:aws:ec2::123456789012:instance/i-1234567890abcdef0");
        ...
        public void testGetCredentialsException() {
            // Arrange
            when(mockAttestationService.getAWSCredentials()).thenThrow(new RuntimeException("Credentials error"));
        ...
        public void testWithBasicAWSCredentials() {
            // Arrange
            BasicAWSCredentials basicCredentials = new BasicAWSCredentials("AKIAIOSFODNN7EXAMPLE", "wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY");
    ...
    class HasValidAwsCredentialsTests {
        ...
        public void testAttestationServiceException() {
            // Arrange
            when(mockAttestationService.getAWSCredentials()).thenThrow(new RuntimeException("Service error"));
    ...
    class IsValidArnForWifTests {
        ...
        public void testValidIamUserArn() {
            // Act & Assert
            assertTrue(PlatformDetectionUtil.isValidArnForWif("arn:aws:iam::123456789012:user/ExampleUser"));
            assertTrue(PlatformDetectionUtil.isValidArnForWif("arn:aws:iam::123456789012:user/path/to/user"));
            assertTrue(PlatformDetectionUtil.isValidArnForWif("arn:aws-us-gov:iam::123456789012:user/GovUser"));
        }
        ...
        public void testValidStsAssumedRoleArn() {
            // Act & Assert
            assertTrue(PlatformDetectionUtil.isValidArnForWif("arn:aws:sts::123456789012:assumed-role/MyRole/MySession"));
            assertTrue(PlatformDetectionUtil.isValidArnForWif("arn:aws:sts::123456789012:assumed-role/path/to/role/session"));
            assertTrue(PlatformDetectionUtil.isValidArnForWif("arn:aws-us-gov:sts::123456789012:assumed-role/GovRole/GovSession"));
        }
        ...
        public void testInvalidArnFormats() {
            ...
            assertFalse(PlatformDetectionUtil.isValidArnForWif("arn:aws:ec2::123456789012:instance/i-1234567890abcdef0"));
            assertFalse(PlatformDetectionUtil.isValidArnForWif("arn:aws:s3:::my-bucket"));
            assertFalse(PlatformDetectionUtil.isValidArnForWif("arn:aws:lambda:us-east-1:123456789012:function:my-function"));
            assertFalse(PlatformDetectionUtil.isValidArnForWif("arn:aws:iam::123456789012:role/MyRole")); // role, not assumed-role
        }
        ...
        public void testMalformedUserArns() {
            // Act & Assert
            assertFalse(PlatformDetectionUtil.isValidArnForWif("arn:aws:iam::123456789012:user/")); // empty user name
            assertFalse(PlatformDetectionUtil.isValidArnForWif("arn:aws:iam::123456789012:user")); // missing user name
            assertFalse(PlatformDetectionUtil.isValidArnForWif("arn:aws:iam:123456789012:user/MyUser")); // missing region separator
        }
        ...
        public void testMalformedAssumedRoleArns() {
            // Act & Assert
            assertFalse(PlatformDetectionUtil.isValidArnForWif("arn:aws:sts::123456789012:assumed-role/")); // empty role/session
            assertFalse(PlatformDetectionUtil.isValidArnForWif("arn:aws:sts::123456789012:assumed-role")); // missing role/session
            assertFalse(PlatformDetectionUtil.isValidArnForWif("arn:aws:sts:123456789012:assumed-role/MyRole/MySession")); // missing region separator
        }
    }
} 