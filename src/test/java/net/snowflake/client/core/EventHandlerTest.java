...
public class EventHandlerTest {
  ...
  public void testPublishRecord() {
    ...
    Assertions.assertEquals(0, handler.getLogBufferSize());
    handler.publish(record);
    Assertions.assertEquals(1, handler.getLogBufferSize());
  }
  ...
  public void testDumpLogBuffer() throws IOException {
    ...
    Assertions.assertTrue(sWriter.toString().contains("test message"));
  ...
  public void testEventFlusher() {
    ...
    Assertions.assertEquals(0, handler.getBufferSize());
    handler.triggerBasicEvent(Event.EventType.STATE_TRANSITION, "test event");
    Assertions.assertEquals(1, handler.getBufferSize());
