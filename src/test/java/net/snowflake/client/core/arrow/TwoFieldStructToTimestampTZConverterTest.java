...
public class TwoFieldStructToTimestampTZConverterTest extends BaseConverterTest
{
  ...
  public void testTimestampTZ() throws SFException
  {
    ...
    Field bigIntField = new Field(TwoFieldStructToTimestampTZConverter.FIELD_NAME_EPOCH, fieldType, null);

    Field smallIntField = new Field(TwoFieldStructToTimestampTZConverter.FIELD_NAME_TIME_ZONE_INDEX, fieldType2, null);
