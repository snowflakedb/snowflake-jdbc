...
public class TwoFieldStructToTimestampNTZConverterTest extends BaseConverterTest
{
  ...
  public void testTimestampNTZ(long[] testSecondsInt64, int[] testNanoSecs, String[] testTimesJson) throws SFException
  {
    ...
    Field bigIntField = new Field(TwoFieldStructToTimestampNTZConverter.FIELD_NAME_EPOCH, fieldType, null);

    Field intField = new Field(TwoFieldStructToTimestampNTZConverter.FIELD_NAME_FRACTION, fieldType2, null);
    ...
    BigIntVector epochs =
        structVector.getChild(TwoFieldStructToTimestampNTZConverter.FIELD_NAME_EPOCH, BigIntVector.class);

    IntVector fractions =
        structVector.getChild(TwoFieldStructToTimestampNTZConverter.FIELD_NAME_FRACTION,
                              IntVector.class);
