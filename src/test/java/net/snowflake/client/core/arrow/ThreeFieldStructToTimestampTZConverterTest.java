...
public class ThreeFieldStructToTimestampTZConverterTest extends BaseConverterTest
{
  ...
  public void testTimestampTZ(long[] testSecondsInt64, int[] testNanos, int[] testTimeZoneIndices, String[] testTimesJson) throws SFException
  {
    ...
    BigIntVector seconds = structVector.getChild(ThreeFieldStructToTimestampTZConverter.FIELD_NAME_EPOCH,
                                                 BigIntVector.class);
    IntVector nanos = structVector.getChild(ThreeFieldStructToTimestampTZConverter.FIELD_NAME_FRACTION,
                                            IntVector.class);
    IntVector timeZoneIdx =
        structVector.getChild(ThreeFieldStructToTimestampTZConverter.FIELD_NAME_TIME_ZONE_INDEX,
                              IntVector.class);
