...
public class CertificateChainTrustValidationTestIT {

  private static final SFLogger logger =
      SFLoggerFactory.getLogger(CertificateChainTrustValidationTestIT.class);
  ...
  private static InputStream getResourceStream(String resourceName) {
    InputStream is =
        CertificateChainTrustValidationTestIT.class
            .getClassLoader()
