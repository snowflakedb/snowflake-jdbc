...
@Tag(TestTags.CORE)
public class OAuthAuthorizationCodeFlowIT extends BaseWiremockTest {
  ...
  private static final SFLogger logger =
      SFLoggerFactory.getLogger(OAuthAuthorizationCodeFlowIT.class);
  ...
  public OAuthAuthorizationCodeFlowIT() throws SFException {}
