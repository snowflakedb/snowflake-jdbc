...
public class SnowflakeUtilTest extends BaseJDBCTest {
    ...
    public void testCreateMetadata() throws Throwable {
        ...
        SnowflakeColumnMetadata expectedColumnMetadata = createExpectedMetadata(rootNode, fieldOne, fieldTwo);
        //when
        SnowflakeColumnMetadata columnMetadata = SnowflakeUtil.extractColumnMetadata(rootNode, false, null);
        //then
        assertNotNull(columnMetadata);
        assertEquals(OBJECT_MAPPER.writeValueAsString(expectedColumnMetadata), OBJECT_MAPPER.writeValueAsString(columnMetadata));
    }
    ...
    private static SnowflakeColumnMetadata createExpectedMetadata(JsonNode rootNode, JsonNode fieldOne, JsonNode fieldTwo) throws SnowflakeSQLLoggedException {
        ColumnTypeInfo columnTypeInfo = getSnowflakeType(rootNode.path("type").asText(), false, null, null);
        ColumnTypeInfo columnTypeInfoNodeOne = getSnowflakeType(fieldOne.path("type").asText(), false, null, null);
        ColumnTypeInfo columnTypeInfoNodeTwo = getSnowflakeType(fieldTwo.path("type").asText(), false, null, null);
        SnowflakeColumnMetadata expectedColumnMetadata = new SnowflakeColumnMetadata(rootNode.path("name").asText(),
                ...
                new MetadataField[]{
                        new MetadataField(fieldOne.path("name").asText(),
                        ...
                        new MetadataField(fieldTwo.path("name").asText(),
    ...
    private JsonNode createFieldNode(String name, Integer precision, Integer byteLength, Integer scale, String type, boolean nullable, String collation, Integer length) {
