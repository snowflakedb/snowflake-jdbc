...
public class ConnectionIT extends BaseJDBCTest {
  ...
  public void testTelemetryError() throws SQLException {
    ...
    Statement statement = con.createStatement();
    statement.execute("create or replace table test_table (ycsb_key int, field1 int, field2 int, field3 int, field4 int, field5 int, field6 int, field7 int, field8 int, field9 int, field10 int)");
    ...
    for (int i = 0; i < 2; i++) {
      ...
      int res = statement.executeUpdate("DELETE FROM test_table WHERE ycsb_key IN (98301, 1000001, 10002)");
      System.out.println("Deleted: " + res);
      res = statement.executeUpdate("UPDATE test_table SET FIELD1=1,FIELD2=2,FIELD3=3,FIELD4=4,FIELD5=5, FIELD6=6,FIELD7=7,FIELD8=8, FIELD9=9,FIELD10=10 WHERE YCSB_KEY=98301");
