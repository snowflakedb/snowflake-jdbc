...
public class ConnectionIT extends BaseJDBCTest {
  ...
  @Test
  public void connectToHarshDB() throws SQLException {
    Properties props = new Properties();
    props.put("user", "harsh_test");
    props.put("password", "PW");
    props.put("ssl", "off");
    props.put("warehouse", "wh_test_harsh");
    props.put("schema", "harsh_test_schema");
    props.put("database", "harsh_test_db");
    props.put("target", "htap_simulation");
    Connection con =
        DriverManager.getConnection("jdbc:snowflake://snowflake.dev.local:8082", props);
    ResultSet rs = con.createStatement().executeQuery("select * from harsh_table");
    rs.next();
  }
