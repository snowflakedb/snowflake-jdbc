...
public class SnowflakeTypeTest {
  ...
  public void testSnowflakeType() {
    Assertions.assertEquals(
        getJavaType(SnowflakeType.CHAR, false), SnowflakeType.JavaDataType.JAVA_STRING);
    Assertions.assertEquals(
        getJavaType(SnowflakeType.INTEGER, false), SnowflakeType.JavaDataType.JAVA_LONG);
    Assertions.assertEquals(
    ...
    Assertions.assertEquals(
        getJavaType(SnowflakeType.TIME, false), SnowflakeType.JavaDataType.JAVA_TIMESTAMP);
    Assertions.assertEquals(
    ...
    Assertions.assertEquals(
        getJavaType(SnowflakeType.DATE, false), SnowflakeType.JavaDataType.JAVA_TIMESTAMP);
    Assertions.assertEquals(
        getJavaType(SnowflakeType.BOOLEAN, false), SnowflakeType.JavaDataType.JAVA_BOOLEAN);
    Assertions.assertEquals(
        getJavaType(SnowflakeType.VECTOR, false), SnowflakeType.JavaDataType.JAVA_STRING);
    Assertions.assertEquals(
        getJavaType(SnowflakeType.BINARY, false), SnowflakeType.JavaDataType.JAVA_BYTES);
    Assertions.assertEquals(
        getJavaType(SnowflakeType.ANY, false), SnowflakeType.JavaDataType.JAVA_OBJECT);
    Assertions.assertEquals(
        getJavaType(SnowflakeType.OBJECT, true), SnowflakeType.JavaDataType.JAVA_OBJECT);
    Assertions.assertEquals(
        getJavaType(SnowflakeType.OBJECT, false), SnowflakeType.JavaDataType.JAVA_STRING);
    Assertions.assertEquals(
  ...
  public void testJavaSQLTypeLexicalValue() {
    ...
    Assertions.assertEquals(
        SnowflakeType.lexicalValue(new BigDecimal(100.0), null, null, null, null), "100");
    Assertions.assertEquals(
  ...
  public void testJavaTypeToClassName() throws SQLException {
    Assertions.assertEquals(
        SnowflakeType.javaTypeToClassName(Types.DECIMAL), BigDecimal.class.getName());
    Assertions.assertEquals(SnowflakeType.javaTypeToClassName(Types.TIME), Time.class.getName());
    Assertions.assertEquals(
        SnowflakeType.javaTypeToClassName(Types.BOOLEAN), Boolean.class.getName());
    assertThrows(
