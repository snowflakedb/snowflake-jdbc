...
public class StructuredTypesGetStringArrowJsonCompatibilityIT extends StructuredTypesGetStringBaseIT {
    ...
    public StructuredTypesGetStringArrowJsonCompatibilityIT(ResultSetFormatType queryResultFormat,
                                                            String selectSql,
    ...
    public void testRunAsGetString() throws SQLException {
        withFirstRow(
                ...
                selectSql,
                (resultSet) -> assertGetStringIsCompatible(
    ...
    public static Collection<Object[]> data() {
        ...
        for (ResultSetFormatType resultSetFormatType : ResultSetFormatType.values()) {
            samples.forEach((sql, expected) -> parameters.add(new Object[]{resultSetFormatType, sql, expected}));
        }
