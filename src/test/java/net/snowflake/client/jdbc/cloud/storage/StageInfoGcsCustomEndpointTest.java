  ...
  private static class DataProvider extends SnowflakeArgumentsProvider {
    ...
    protected List<Arguments> rawArguments(ExtensionContext context) {
      return Arrays.asList(
              ...
              Arguments.of("ME-CENTRAL2", false, null, Optional.of("storage.me-central2.rep.googleapis.com")),
              Arguments.of("ME-CENTRAL2", true, null, Optional.of("storage.me-central2.rep.googleapis.com")),
              Arguments.of("ME-CENTRAL2", true, "", Optional.of("storage.me-central2.rep.googleapis.com")),
              Arguments.of("ME-CENTRAL2", true, "  ", Optional.of("storage.me-central2.rep.googleapis.com")),
              Arguments.of("ME-CENTRAL2", true, "example.com", Optional.of("example.com")),
              Arguments.of("US-CENTRAL1", true, null, Optional.of("storage.us-central1.rep.googleapis.com")),
              Arguments.of("US-CENTRAL1", true, "", Optional.of("storage.us-central1.rep.googleapis.com")),
              Arguments.of("US-CENTRAL1", true, " ", Optional.of("storage.us-central1.rep.googleapis.com")),
              Arguments.of("US-CENTRAL1", true, "null", Optional.of("storage.us-central1.rep.googleapis.com")),
