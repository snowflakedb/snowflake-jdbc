...
public class TelemetryUtilTest {
    ...
    public void testCreateIBValueWithAllValues() {
        ...
        assertEquals(LoginInfoDTO.SF_JDBC_APP_ID, on.get(TelemetryField.DRIVER_TYPE.toString()).asText());
        assertEquals(SnowflakeDriver.implementVersion, on.get(TelemetryField.DRIVER_VERSION.toString()).asText());
