...
public class StatementIT extends BaseJDBCTest
{
  ...
  public void testExecuteSelect() throws SQLException
  {
    Connection connection = getConnection();
    Statement statement = connection.createStatement();
    assertNull(statement.unwrap(SnowflakeStatement.class).getQueryID());
    ...
    assertTrue(success);
    String queryID2 = statement.unwrap(SnowflakeStatement.class).getQueryID();
    ...
    String queryID3 = rs.unwrap(SnowflakeResultSet.class).getQueryID();
  ...
  public void testUnwrapper() throws Throwable
  {
    try (Connection connection = getConnection())
    {
      ...
      {
        SnowflakeStatementV1 sfstatement = statement.unwrap(SnowflakeStatementV1.class);
        sfstatement.execute("select 1");
      }
      else
      {
